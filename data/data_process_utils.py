...
def calc_n_nodes_per_layer(n_real_nodes: int, root_leaf_factor: int, min_root_nodes: int) -> list[int]:
    ...
    """
    nodes_count_per_layer = [n_real_nodes]

    while nodes_count_per_layer[-1] >= min_root_nodes * root_leaf_factor:
        nodes_count_per_layer.append(nodes_count_per_layer[-1] // root_leaf_factor)
...
def calculate_virtual_nodes_and_edges(real_nodes: np.array,
    ...
    # sure that this is the case (Actually Redundant There)
