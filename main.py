...
flags.DEFINE_enum('mode', 'train', ['train', 'evaluate', 'evaluate_all'], help = 'Fit model to training data or evaluate on test data')
...
def evaluate_all(data_path, K, n_shape_coeff, n_epochs, lr, trained_params_dir, fixed_geom, dir_label):
    ...
    real_node_coords_all = np.concatenate((train_data._real_node_coords, validation_data._real_node_coords, test_data._real_node_coords), axis = 0)
